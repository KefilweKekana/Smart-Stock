...
def send_low_stock_alerts():
    ...
    """
    # Get alert settings
    settings = frappe.get_single("Smart Stock Settings")
...
def check_critical_stock():
    ...
    if not settings.enable_critical_alerts:
        return
...
def get_alert_recipients():
    ...
    if settings.alert_recipients:
        return [d.user for d in settings.alert_recipients]
